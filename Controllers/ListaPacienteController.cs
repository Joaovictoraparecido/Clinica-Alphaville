...
namespace CLINICA_ALPHAVILLE.Controllers
{
    public class ListaPacienteController : Controller
    {
        ...
        public ListaPacienteController(DATACLINICA context)
        {
            _context = context;
        }
        ...
        // GET: ListaPaciente/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ListaPaciente/Create
